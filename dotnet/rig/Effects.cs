...
namespace Rig
{
    ...
    public static class Effects
    {
        ...
        public static string RunEffects(bool superHost, bool perf)
        {
            int frames = 72;
            ...
            byte[] packed = Rig.Pack(GenYm.Ym6File(frames, values, drum0, drum1),
                    960, 24, true, 1);
            var player = new Player(packed, Rig.WorkspaceSize(960), 1,
                    superHost, perf);
            if (player.Init() != 0)
            {
            ...
            var reused = new Player(packed, Rig.WorkspaceSize(960), 1,
                    superHost, perf);
            if (reused.Init() != 0)
            {
